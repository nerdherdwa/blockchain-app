...
from scripts.modules.utils.crypto_hash import crypto_hash
from scripts.modules.utils.hex_to_binary import hex_to_binary
from scripts.config import MINE_RATE
...
class Block:
    ...
    def to_json(self):
        """
        Serialize the block into a ditionary of its attribute
        """
    ...
    def is_valid_block(last_block, block):
        ...
        Validate block by enforcing the following rules:
         ...
         - the difficulty may only adjust by 1
