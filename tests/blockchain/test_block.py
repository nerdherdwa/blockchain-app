...
from scripts.config import MINE_RATE, SECONDS
...
def test_is_valid_block_jumped_difference(last_block, block):
    jumped_diff = 10
...
def test_is_valid_block_bad_block_hash(last_block, block):
    block.hash = '000000000000000bbbbabababc'
